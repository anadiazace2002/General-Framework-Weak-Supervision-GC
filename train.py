...
def get_config():
    ...
    parser.add_argument('--load_path', type=str, default = '/home/anadiaz/General-Framework-Weak-Supervision-GC/saved_models/noisy_label/classic_cv/imp_noisy_label_cifar100_sym_0.5_42/latest_model.pth')
